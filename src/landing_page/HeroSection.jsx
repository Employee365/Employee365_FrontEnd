...
const HeroSection = () => {
  ...
  return (
    <main className="bg-[#E0EBF4] py-[3rem] px-[7rem] relative ">
      <motion.section className="bg-white  py-[6rem] px-[3rem] w-full rounded-3xl shadow-3xl "
      variants={containerVariant}
      initial='hidden'
      whileInView='visible'
      transition={{ duration: 0.5, delay: 0.10 }}>
        <motion.h1 className="text-[42px] font-[400] w-[721px] leading-10"
        ...
        <div className="ss:flex-row lg:flex  justify-between gap-3">
          <div className="mt-[2rem]">
            <motion.p className="text-[20px] font-[400]"
            variants={wordVariant}
            initial='hidden'
            whileInView='visible'
            transition={{ duration: 0.5, delay: 0.10 }}>
