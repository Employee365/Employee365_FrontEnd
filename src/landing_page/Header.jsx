...
const Header = () => {
  return (
    <header className="bg-[#E0EBF4] py-[3rem] px-[7rem] flex justify-between items-center ">
      <div className="flex items-center text-[25px] font-bold ">
        ...
        <h1>EMPLOYEE <span>365</span></h1>
      </div>
      <div>
        <ul className="flex gap-6 text-[25px] cursor-pointer font-normal">
      ...
      <div>
        <button className="text-[25px] font-bold rounded-[15px] bg-white shadow-4xl  py-[18px] px-[64px] inline-block">Login</button>
      </div>
    </header>
  );
};
